...
<div role="document" class="page"> 
  ...
  <div class="show-for-small mobile-phone"><a  href="tel:(877)825-5233">877.825.5233</a> <a href="" class="right">Log In</a></div>
  <!--/.l-header -->
  ...
  <div class="h1-bg"> <?php print render($title_prefix); ?>
    <h1 id="page-title" class="title main"><span>WHITEPAPERS</span></h1>
  ...
  <main role="main" class="row l-main page-row">
    <div class="<?php print $main_grid; ?> main columns whitepaper">
  ...
  <footer class="l-footer  row" role="contentinfo">
    ...
    <div class="footer large-12 columns"> <?php print render($page['footer']); ?>
      <div class="copyright large-12 columns"> &copy; <?php print date('Y') . '  ' . t('Effective Data. All rights reserved.'); ?> | <a href="#">Sitemap</a> | <a href="/content/privacy-policy">Privacy Policy</a> | <a href="/content/terms-use">Terms of use</a> </div>
    </div>
    <?php endif; ?>
  </footer>
  <!--/.footer-->
